...
<p style="float: right;">${bvo.regAt }</p>
<p style="float: right;">조회 : ${bvo.readCount }</p>
...
<a href="/board/modify?bno=${bvo.bno }"><button type="button"class="btn btn-outline-secondary" id="regBtn" style="float: right;">수정</button></a>
<a href="/board/delete?bno=${bvo.bno }"><button type="button"class="btn btn-outline-danger" id="regBtn" style="float: right;">삭제</button></a>
</div>
