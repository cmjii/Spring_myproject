...
<form action="/board/modify" method="post" enctype="multipart/form-data">
  <div class="col-12">
    ...
    <input type="text" name="title" class="form-control" placeholder="${bvo.title }" id="inputEmail4">
  </div> <br>
  <div class="col-12">
    <label for="inputPassword4" class="form-label">작성자</label>
    <input type="text" name="writer" class="form-control" placeholder="${bvo.writer }" readonly="readonly" id="inputPassword4">
  </div> <br>
  <div class="col-12">
    <label for="inputAddress" class="form-label">내용</label>
    <textarea rows="15" name="content"  cols="10" class="form-control" placeholder="${bvo.content }"></textarea>
  </div><br>
