...
import com.myproject.www.security.CustomAuthMemberService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter { // 상속 받아 환경설정
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().disable();
		  ...
		  //승인요청 //antMatchers : 접근을 허용하는 값 //permitAll() :누구나 접근 가능하는 경로
		  ...
		  //커스텀 로그인 페이지 구성 //controller에 주소요청 맵핑이 같이 있어야 함 (필수)
