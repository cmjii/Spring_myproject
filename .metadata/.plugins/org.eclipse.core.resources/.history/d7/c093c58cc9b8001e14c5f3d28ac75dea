...
public class MemberController {
	...
	public String register(MemberVO mvo, RedirectAttributes re,HttpServletRequest request) {
		log.info("mvo >>>>>>>>>>>>>> "+ mvo);
	...
	//아이디 중복확인
	@GetMapping(value ="/{regEmail}", produces = MediaType.TEXT_PLAIN_VALUE)
	public ResponseEntity<String> regEamil(@PathVariable("regEmail") String email) {
	    log.info("email++++++++++++++++++++++++++++++++++++++++++++++++++++" + email);
	    MemberVO mvo = msv.selectEmail(email);
	    log.info("mvo++++++++++++++++++++++++++++++++++++++++++++++++++++" + mvo);
